    ...
    return !fontsLoaded ? <AppLoading /> : (
        ...
        <ScrollView style={{ ...styles.Mainview, backgroundColor: darkMode ? customDarkMode.backgroundColor : customLightMode.backgroundColor }}>
            ...
            {workspaceUsers ? <View style={{ paddingBottom: 2, alignItems: "center" }}>
                <TouchableOpacity
                onPress={()=> setChooseMembers(true)}
                style={{ width: "50%" , backgroundColor:colors.blue , borderRadius:20 , alignItems:"center",justifyContent:"center" , height:50 , marginTop:20 }}>
                    <Text style={{ color: customDarkMode.textColor , fontSize:17 , fontFamily: "Poppins_600SemiBold"}} >Tag Person</Text>
                </TouchableOpacity>
            ...
            <Modal
                        animationType="slide"
                        transparent={true}
                        visible={chooseMembers}
                        onRequestClose={() => {
                            setChooseMembers(false);
                        }}
                    >
                        <View style={styles.centeredView}>
                            <View style={{ ...styles.modalView, height: "35%" }}>
                                ...
                                <SelectBox
                                     label=""
                                     options={workspaceUsers ? workspaceUsers : null}
